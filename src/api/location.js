...
async function getAttractionDetail(attraction, success, fail) {
  return await api({
    method: 'GET',
    url: `/detailIntro1?serviceKey=${serviceKey}`,
    params: {
      MobileOS: 'ETC',
      MobileApp: 'AlongAlong',
      _type: 'json',
...
export { getLocationBasedList, getAttractionCategory, getAttractionDetail }
